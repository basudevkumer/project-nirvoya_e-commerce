        ...
        <section className="py-16">
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-3xl grid lg:grid-cols-3 gap-12">
                    <div>
                        <p className="text-xl text-gray-500 mb-3 font-medium">Customer Review</p>
                    ...
                    <button className="w-45 h-15 px-6 py-2 bg-[#0198E9] text-white text-sm rounded cursor-pointer hover:bg-[#0381c5]">Write a review</button>
                </div>
                    ...
                    <div>
                        {reviews.map((review, index) => (
                            <div key={index} className="mb-6">
                                ...
                                <p className="text-sm sm:text-base text-gray-600">{review.text}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="container mx-auto max-w-3xl px-4 mt-12">
                <h3 className="text-[24px] font-semibold text-[#383838]">Add your review</h3>
